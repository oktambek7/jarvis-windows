...
overlay itself (`jarvis.ui.overlay`, `jarvis.ui.runtime`) needs PySide6 +
qasync and is only imported when `ui.overlay.enabled` is true AND those
packages are installed — see `jarvis.ui.runtime.overlay_available()`.
"""
